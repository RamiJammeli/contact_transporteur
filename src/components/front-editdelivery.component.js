    ...
    constructor(props) {
        ...
        componentDidMount(){
            ...
            .then(res=>{  this.setState({ 
                ...
                prix_initial:res.data.prix_initial,
                prix_total:res.data.prix_total,
                datelivraison:new Date(res.data.datelivraison),
                type_livraison:res.data.type_livraison,
          ...
          onSubmit(e) {
            ...
            const delivery = {
              ...
              axios.post('http://localhost:5000/deliveries/update', delivery)
